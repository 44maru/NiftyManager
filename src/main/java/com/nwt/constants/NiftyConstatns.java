...
public class NiftyConstatns {
	...
	public static final Map<String, String> ENDPOINT_MAP = Map.of(
			REGION_EAST_1, ENDPOINT_EAST_1, REGION_EAST_2, ENDPOINT_EAST_2,
			REGION_EAST_3, ENDPOINT_EAST_3, REGION_EAST_4, ENDPOINT_EAST_4,
			REGION_JP_EAST_4, ENDPOINT_EAST_4,
			REGION_US_EAST_1, ENDPOINT_US_EAST_1, REGION_WEST_1, ENDPOINT_WEST_1);
